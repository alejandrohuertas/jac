...
public class FileTransfererService extends Service{
    ...
    private final static QName FILETRANSFERERSERVICE_QNAME = new QName("http://server.mtom.ws.jac/", "FileTransfererService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9898/jac.app/fileService?wsdl");
    ...
    public FileTransferer getFileTransfererPort() {
        return super.getPort(new QName("http://server.mtom.ws.jac/", "FileTransfererPort"), FileTransferer.class);
    }
    ...
    public FileTransferer getFileTransfererPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.mtom.ws.jac/", "FileTransfererPort"), FileTransferer.class, features);
    }
